...
def run(
    ...
    is_coco = isinstance(data.get('val'), str) and 'coco' in data_file_name  # COCO dataset
    ...
    if save_json and len(jdict):
        ...
        anno_json = str('../datasets/coco/annotations/' + eval_data)  # annotations json
...
def parse_opt():
    ...
    parser.add_argument('--eval-data', type=str, default='instances_val2017.json', help='evaluation data for pycocotools')
